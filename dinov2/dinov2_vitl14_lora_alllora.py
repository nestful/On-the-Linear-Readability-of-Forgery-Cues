#微调dinov2 qkv、proj（注意力层）和 mlp（MLP层）(包括两个mlp.fc1,mlp.fc2)
#dinov2_vitl14_lora只微调了qkv,proj没有微调mlp层
import torch
...
def main():
    ...
    best_acc = 0.0
    best_epoch = 0
    best_model_path = os.path.join(CFG['ckpt_dir'], 'best_model_alllora_linear.pth')
